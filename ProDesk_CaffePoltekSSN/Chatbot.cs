...
namespace ProDesk_CaffePoltekSSN
{
    ...
    {
        static readonly OpenAIAPI api = new("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");
        ...
        //async maksudnya bisa tetap berjalan walaupun kita ngeakses yang lain
        {
        ...
        private async void Chatbot_Load(object sender, EventArgs e)
        {
